...
def get_features(data):
    ...
    # # # # ข้อ 5
    features['ข้อห้า'] = 'อิเล็กทรอนิกซ์' in words or 'อิเล็กทรอนิก' in words or 'อิเล็กทรอนิกส์' in words or 'DBD' in words or 'dbd' in words or 'registered' in words or 'Registered' in words or 'electronics' in words or 'electronics' in words or 'Electronics' in words or 'Electronics' in words
